...
* `app_plano_viver` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `app_plano_viver` - executable or bundle name on disk.
* `app_plano_viver` - display name shown in window titles and about app dialogs.
